...
int main(void) {
    ...
    rc = req_request(CLAUDE_REP, "{\"action\":\"status\"}", resp, sizeof(resp));
    assert(rc > 0);
    ...
    memset(resp, 0, sizeof(resp));
    rc = req_request(CLAUDE_REP, "{\"action\":\"memory\"}", resp, sizeof(resp));
    assert(rc > 0);
    assert(strstr(resp, "\"ok\":true") != NULL);
    assert(strstr(resp, "\"memory\":[]") != NULL);
    PASS();
    ...
    memset(resp, 0, sizeof(resp));
    rc = req_request(CLAUDE_REP, "{\"action\":\"forget\"}", resp, sizeof(resp));
    assert(rc > 0);
    assert(strstr(resp, "\"ok\":true") != NULL);
